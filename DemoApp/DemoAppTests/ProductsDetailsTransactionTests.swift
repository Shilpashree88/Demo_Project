//
//  ProductsDetailsTransactionTests.swift
//  DemoApp
//
...
final class ProductsDetailsTransactionTests: XCTestCase {
    
    var cancellables: Set<AnyCancellable>!
    var mockNetworkService: MockNetworkService!
    var repository: ProductsDetailsTransaction!
    
    override func setUpWithError() throws {
        cancellables = []
        mockNetworkService = MockNetworkService(transcaction: MockAPITransaction())
        repository = ProductsDetailsTransaction(service: mockNetworkService)
    }
